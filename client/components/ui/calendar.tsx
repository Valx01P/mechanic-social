  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          "bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] hover:bg-[hsl(var(--primary))] hover:text-[hsl(var(--primary-foreground))] focus:bg-[hsl(var(--primary))] focus:text-[hsl(var(--primary-foreground))] rounded-md",
        today: "bg-[hsl(var(--accent))] text-[hsl(var(--accent-foreground))] rounded-md",
        outside: "text-[hsl(var(--muted-foreground))] opacity-50",
